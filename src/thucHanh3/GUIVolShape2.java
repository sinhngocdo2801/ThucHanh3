...
public class GUIVolShape2 extends javax.swing.JFrame {
	    ...
	    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
	        ...
	        if(evt.getSource() == jButton1){
	            double a = Double.parseDouble(jTextField1.getText());
	            jTextField4.setText(Double.toString((4*Math.PI*a*a*a)/3));
	        }
	    }                                        
	    
	    //Thai Cong Binh
	    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
	        //Cube ( Khoi hop hinh vuong )
	        if(evt.getSource() == jButton2){
	            double b = Double.parseDouble(jTextField2.getText());
	            jTextField4.setText(Double.toString(b*b*b));
	        }
	    }                                        
	    
	    //Truong Nhat hao
	    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
	       //Rectangle Tank ( Hinh hcn dung )
	        if(evt.getSource() == jButton3){
	            double a = Double.parseDouble(jTextField1.getText());
	            double b = Double.parseDouble(jTextField2.getText());
	            double c = Double.parseDouble(jTextField3.getText());
	            jTextField4.setText(Double.toString(a*b*c));
	        }
	    }                                                                             
	    //Bui Son Thai
